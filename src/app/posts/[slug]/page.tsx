"use client"; // Ensure useRouter works in Next.js App Router
...
export default function PostPage({ params }: PostPageProps) {
  ...
  return (
    ...
    <div className="max-w-3xl">
      <div className="w-[1521px] mx-auto">
      ...
      <div className="max-w-3xl mx-auto p-6 bg-background rounded-lg overflow-hidden">
        {/* Text Content */}
        <div className="p-6">
